...
<head>
    ...
    <title>@yield('title', 'Approve unapproved orders')</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Unfinished Orders
                        </h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                @if(gettype($unfinished_orders) =="string")
                    <p>{!! $unfinished_orders !!}</p>
                @else
                    <table>
                        <thead>
                        <tr>
                        ...
                        @foreach($unfinished_orders as $order)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('moderator.finish') }}" method="post">
                                        @csrf
